...
def compress_video(video_path, preset_file):
    ...
    command = f"HandBrakeCLI -i \"{video_path}\" -o \"{output_filename}\" --preset-import-file \"{preset_file}\" -Z \"H.265 NVEC 720p 28 Quality\" -e nvenc_h265"
